...
Now you should be able to send a message on one client, watch the server read it, and see the message show up on the other client's side. Each client will be able to talk to the other.
